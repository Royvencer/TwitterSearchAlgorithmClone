...
class Trendtracker
{
	...
	private:
		...
		int search(string ht);// Optional helper method.
		...
		vector<Entry> E;// Entries sorted (lexicographically) by hashtag.
		
		
		vector<int> S;// Stores indices of the (up to) three most-tweeted
		// entries in E.
};
